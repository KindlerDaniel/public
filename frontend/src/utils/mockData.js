...
export const CATEGORIES = {
  ...
  // Mock-Kommentare für Inhalte
  const mockComments = {
    'content1': [
      {
        id: 'comment1-1',
        author: USERS[3].name,
        content: 'Ich finde, Lehmann hat in vielen Punkten recht. Die Entwicklung der KI wird oft zu unkritisch betrachtet.',
        ...
        replies: [
          {
            id: 'comment1-1-1',
            author: USERS[5].name,
            content: 'Das sehe ich anders. Racknick hat in seinen letzten Publikationen sehr differenziert argumentiert.',
            date: '2025-04-08T16:05:00',
          ...
          },
          {
            id: 'comment1-1-2',
            author: USERS[2].name,
            content: 'Ich denke, die Wahrheit liegt wie so oft in der Mitte.',
            date: '2025-04-08T17:22:00',
      ...
      },
      {
        id: 'comment1-2',
        author: USERS[7].name,
        content: 'Diese Art von öffentlicher Kritik unter Kollegen finde ich unprofessionell.',
        date: '2025-04-09T09:45:00',
    ...
    'content2': [
      {
        id: 'comment2-1',
        author: USERS[1].name,
        content: 'Sehr informatives Video! Die Konzepte für urbane Mobilität sind wirklich durchdacht.',
    ...
    'content3': [
      {
        id: 'comment3-1',
        author: USERS[0].name,
        content: 'Was für ein atemberaubendes Foto! Die Farben sind unglaublich.',
        date: '2025-04-12T19:20:00',
      ...
      },
      {
        id: 'comment3-2',
        author: USERS[9].name,
        content: 'Ich war letzte Woche dort - der See ist wirklich ein verstecktes Juwel in Berlin!',
        date: '2025-04-13T08:15:00',
  ...
  const mockBubbleCoordinates = mockContents.map(content => ({
    id: content.id,
  ...
  // Holt einen zufälligen Inhalt (für Demozwecke)
  export function fetchMockContent() {
    const randomIndex = Math.floor(Math.random() * mockContents.length);
    return mockContents[randomIndex];
  }
  
  // Erstellt einen neuen Kommentar (für Demozwecke)
  ...
  // Erstellt eine Antwort auf einen Kommentar (für Demozwecke)
  ...
  // Aktualisiert die Bewertung eines Inhalts (für Demozwecke)
